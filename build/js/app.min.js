...
;// CONCATENATED MODULE: ./src/js/module/adaptive.js


jquery(() => {
  const $parent = jquery('.adaptive')
  ...
  function isMobile() {
    const size = jquery(window).width()
...
;// CONCATENATED MODULE: ./src/js/module/accordion.js
...
jquery(document).ready(function () {
  ...
  jquery('.faq__item').on('click', (e) => {
    const $target = jquery(e.target).closest('.faq__item')
...
;// CONCATENATED MODULE: ./src/js/module/rarity.js


jquery(() => {
  const $parent = jquery('.rarity')
  const $prize_items = $parent.find('.prize')
  const $rarity_items = $parent.find('.rarity__img')

  $prize_items.on('click', (e) => {
    const $item = jquery(e.target).closest('.prize')
    ...
    $rarity_items.each((_, el) => {
      const idx_img = jquery(el).data('id')

      console.log('elem', el)
      console.log('idx_img', idx_img)
      console.log('index', index)
      idx_img === index
        ? jquery(el).addClass('rarity__img_active')
        : jquery(el).removeClass('rarity__img_active')
    })
  })
})

;// CONCATENATED MODULE: ./src/js/module/loop.js


jquery(() => {
  const $parent = jquery('.tokenomics')
...
;// CONCATENATED MODULE: ./src/js/module/menuScroll.js


jquery(() => {
  const $linkTo = jquery('.to')
  $linkTo.on('click', (e) => {
    e.preventDefault()

    const target = jquery(e.target).closest('.to').attr('href').slice(1)
...
;// CONCATENATED MODULE: ./src/js/module/sound.js
...
jquery(() => {
  const $player = jquery('.palyer__box')

  const $controller = jquery('.player__controller')

  // const $video = $('.video')

  const $buttonWelcome = jquery('.welcome__button')
...
;// CONCATENATED MODULE: ./src/js/module/welcome.js


jquery(() => {
  const $page = jquery('.page')

  const $button = jquery('.welcome__button')

  const $welcome = jquery('.welcome')
  window.scrollTo(0, 0)
  // $(window).scrollTop(0)
  $button.on('click', () => {
